    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="活动介绍" prop="huodongjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.huodongjieshao" label="活动介绍" prop="huodongjieshao">
                    <span v-html="ruleForm.huodongjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.huodongjieshao = this.ruleForm.huodongjieshao.replace(reg,'../../../springboot5r64w/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
