    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="班级简介" prop="banjijianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.banjijianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.banjijianjie" label="班级简介" prop="banjijianjie">
                    <span v-html="ruleForm.banjijianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chuangjianshijian = true;
          ...
          if(o=='banjijianjie'){
            this.ruleForm.banjijianjie = obj[o];
	    this.ro.banjijianjie = true;
            continue;
          }
          if(o=='zhanghao'){
	...
	this.ruleForm.banjijianjie = this.ruleForm.banjijianjie.replace(reg,'../../../springboot5r64w/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
