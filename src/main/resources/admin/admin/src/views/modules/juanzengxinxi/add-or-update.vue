<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠项目" prop="juanzengxiangmu">
          <el-input v-model="ruleForm.juanzengxiangmu" 
              placeholder="捐赠项目" clearable  :readonly="ro.juanzengxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠项目" prop="juanzengxiangmu">
              <el-input v-model="ruleForm.juanzengxiangmu" 
                placeholder="捐赠项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="名义" prop="mingyi">
          <el-input v-model="ruleForm.mingyi" 
              placeholder="名义" clearable  :readonly="ro.mingyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="名义" prop="mingyi">
              <el-input v-model="ruleForm.mingyi" 
                placeholder="名义" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.juanzengshijian" label="捐赠时间" prop="juanzengshijian">
              <el-input v-model="ruleForm.juanzengshijian" 
                placeholder="捐赠时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          juanzengxiangmu: [
                { required: true, message: '捐赠项目不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          zhanghao: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bianhao = true;
          ...
          if(o=='juanzengxiangmu'){
            this.ruleForm.juanzengxiangmu = obj[o];
	    this.ro.juanzengxiangmu = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.juanzengxiangqing = this.ruleForm.juanzengxiangqing.replace(reg,'../../../springboot5r64w/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
