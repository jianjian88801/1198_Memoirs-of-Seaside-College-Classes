...
public class JuanzengxinxiModel  implements Serializable {
	...
	private String juanzengxiangmu;
	...
	public void setJuanzengxiangmu(String juanzengxiangmu) {
		this.juanzengxiangmu = juanzengxiangmu;
	}
	
	/**
	 * 获取：捐赠项目
	 */
	public String getJuanzengxiangmu() {
		return juanzengxiangmu;
	}
